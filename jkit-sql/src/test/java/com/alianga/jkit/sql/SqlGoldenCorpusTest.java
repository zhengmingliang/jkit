...
public class SqlGoldenCorpusTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                {"mysql", "INSERT DELAYED INTO t (id) VALUES (1)"},
                {"mysql", "SELECT * FROM t WHERE BINARY 'abc' = name"},
                {"sqlserver", "SELECT TOP (10) WITH TIES * FROM t ORDER BY id"},
                {"postgres", "SELECT * FROM t TABLESAMPLE SYSTEM (10)"},
                {"oracle", "SELECT * FROM t SAMPLE (5)"},
                ...
                {"sqlserver", "INSERT INTO t (id) OUTPUT INSERTED.id INTO dbo.archive VALUES (1)"},
                {"sqlserver", "INSERT INTO t (id) OUTPUT INSERTED.id INTO @out VALUES (1)"},
                {"sqlserver", "DELETE FROM t OUTPUT DELETED.id INTO #tmp WHERE id = 1"},
