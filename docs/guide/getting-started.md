...
| `jkit-sql-auto-spring-boot-2` | `com.alianga:jkit-sql-auto-spring-boot-2` | Spring Boot 2 自动配置 |
| `jkit-sql-auto-spring-boot-3` | `com.alianga:jkit-sql-auto-spring-boot-3` | Spring Boot 3 自动配置（JDK 17+） |
