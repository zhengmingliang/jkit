package com.alianga.jkit.io.monitor;

import com.alianga.jkit.IOUtils;
import com.alianga.jkit.exception.MonitorException;
...
public class FileMonitor extends MonitorServer {
    ...
    /**
     * 根据路径字符串创建只监听当前目录的监听器。
     *
     * @param path   监听的文件或目录路径
     * @param events 监听事件，未指定时监听全部事件
     * @return 新创建的文件监听器
     */
     ...
     * @param watcher 事件观察者
     * @return 已设置观察者的文件监听器
     * @throws MonitorException URL 无法转换为合法 URI 时抛出
     */
