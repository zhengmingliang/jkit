...
public class Objects {
     ...
     *
     * @param object 候选对象
     * @return 对象中的第一个值；为空时返回 {@code null}
     */
     ...
     * @return 第一个对象转换后的字符串，无法转换时返回默认值
     */
    ...
    /**
     * 判断给定的多个对象是否全部非 {@code null}
     *
     * <pre>
     * Objects.allNotNull()                 = true
     * Objects.allNotNull((Object[]) null)  = false
     * Objects.allNotNull("a", "b")         = true
     * Objects.allNotNull("a", null)        = false
     * </pre>
     *
     * @param values 待判断的对象，数组本身可为 {@code null}
     * @return 全部非 {@code null} 时返回 {@code true}；数组本身为 {@code null} 时返回 {@code false}，
     *         空数组返回 {@code true}
     */
    ...
    /**
     * 判断给定的多个对象中是否存在非 {@code null} 的项
     *
     * <pre>
     * Objects.anyNotNull()                 = false
     * Objects.anyNotNull((Object[]) null)  = false
     * Objects.anyNotNull(null, "b")        = true
     * Objects.anyNotNull(null, null)       = false
     * </pre>
     *
     * @param values 待判断的对象，数组本身可为 {@code null}
     * @return 存在任一非 {@code null} 项时返回 {@code true}；数组为 {@code null} 或空时返回 {@code false}
     */
    ...
    /**
     * 为 {@code null} 时返回默认值，默认值本身也允许为 {@code null}
     *
     * <p>与 {@link #requireNonNullElse(Object, Object)} 的区别是本方法不校验默认值：
     * 两者同时为 {@code null} 时直接返回 {@code null} 而不抛 {@link NullPointerException}。</p>
     *
     * @param object 待判断的对象，可为 {@code null}
     * @param defaultValue 默认值，可为 {@code null}
     * @param <T> 对象类型
     * @return {@code object} 非 {@code null} 时返回它本身，否则返回 {@code defaultValue}
     */
