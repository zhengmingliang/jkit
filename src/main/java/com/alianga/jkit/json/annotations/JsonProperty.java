...
import com.alianga.jkit.json.JSONTypeFieldMapper;
...
public @interface JsonProperty {
     ...
     *
     * @return 参与序列化时返回 {@code true}，默认为 {@code true}
     */
     ...
     * json解析时当前属性是否反序列化
     *
     * @return 参与反序列化时返回 {@code true}，默认为 {@code true}
     */
     ...
     *
     * @return 自定义的字段映射器类型，默认为 JSONTypeFieldMapper 表示不使用自定义映射
     */
     ...
     *
     * @return 序列化为时间戳时返回 {@code true}，默认为 {@code false}
     */
     ...
     *
     * @return 时区表达式，默认为空字符串表示使用 TimeZone 的默认时区
     ...
     * <p> 支持Map/List等指定实现类
     *
     * @return 属性的缺省实现类，默认为 Object 表示不指定
     */
     ...
     *
     * @return 用于选择 possibleTypes 下标的表达式，默认为空字符串表示忽略处理
     */
     ...
     *
     * @return 类型不固定时返回 {@code true}，默认为 {@code false}
     */
