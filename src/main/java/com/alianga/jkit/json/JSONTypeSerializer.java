...
public abstract class JSONTypeSerializer extends JSONGeneral {
    static final Map<Class<?>, JSONTypeSerializer> GLOBAL_SERIALIZERS = new HashMap<Class<?>, JSONTypeSerializer>(32);
    ...
    static final CharSequenceImpl CHAR_SEQUENCE_STRING =
            EnvUtils.JDK_9_PLUS ? new StringJDK9PlusImpl() : new StringJDK8Impl();
    ...
    static final ArrayImpl ARRAY_PRIMITIVE_DOUBLE =
            new ArrayPrimitiveImpl(NUMBER_DOUBLE, ReflectConsts.PrimitiveType.PrimitiveDouble);
    static final ArrayImpl ARRAY_PRIMITIVE_BYTE =
            new ArrayPrimitiveImpl(NUMBER_INTEGER, ReflectConsts.PrimitiveType.PrimitiveByte);
    static final ArrayImpl ARRAY_PRIMITIVE_SHORT =
            new ArrayPrimitiveImpl(NUMBER_INTEGER, ReflectConsts.PrimitiveType.PrimitiveShort);
    static final ArrayImpl ARRAY_PRIMITIVE_FLOAT =
            new ArrayPrimitiveImpl(NUMBER_FLOAT, ReflectConsts.PrimitiveType.PrimitiveFloat);
    static final ArrayImpl ARRAY_PRIMITIVE_BOOLEAN =
            new ArrayPrimitiveImpl(SIMPLE, ReflectConsts.PrimitiveType.PrimitiveBoolean);
    ...
    static {
        ...
        putTypeSerializer(GLOBAL_SERIALIZERS, NUMBER_INTEGER, byte.class, Byte.class, short.class, Short.class,
                int.class, Integer.class, AtomicInteger.class);
        ...
        putTypeSerializer(GLOBAL_SERIALIZERS, CHAR_SEQUENCE, char[].class, StringBuffer.class, StringBuilder.class,
                char.class, Character.class);
        JSONTypeExtensionSer.initExtens();
    }

    static void putTypeSerializer(Map<Class<?>, JSONTypeSerializer> serializerMap, JSONTypeSerializer typeSerializer,
                                  Class<?>... types) {
     ...
     *
     * @param value      待序列化的对象
     * @param writer     json 输出目标
     * @param jsonConfig 序列化配置
     * @param indent     当前缩进层级，格式化输出时使用
     * @throws Exception 写出过程中发生的异常
     */
    protected abstract void serialize(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent)
            throws Exception;

    /**
     * 按需写出类型标识（"@c" 属性）。
     *
     * @param writeClassName 是否需要写出类型名称
     * @param writer         json 输出目标
     * @param clazz          要写出的类型
     * @param formatOut      是否格式化输出
     * @param indentLevel    当前缩进层级
     * @param jsonConfig     序列化配置
     * @return 实际写出了类型标识时返回 {@code true}，否则返回 {@code false}
     * @throws IOException 写出过程中发生 IO 异常
     */
    protected boolean checkWriteClassName(boolean writeClassName, JSONWriter writer, Class clazz, boolean formatOut,
                                          int indentLevel, JSONConfig jsonConfig) throws IOException {
        if (writeClassName) {
    ...
    void writeType(JSONWriter writer, Class clazz, boolean formatOut, int indentLevel, JSONConfig jsonConfig)
            throws IOException {
    ...
    static class SimpleNumberImpl extends SimpleImpl {
        protected void serializeNumber(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent)
                throws Exception {
    ...
    // integer/byte/short
    static final class IntegerImpl extends SimpleImpl {
        protected void serialize(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent) throws Exception {
    ...
    static final class DoubleImpl extends SimpleImpl {
        protected void serialize(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent) throws Exception {
    ...
    static final class FloatImpl extends SimpleImpl {
        protected void serialize(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent) throws Exception {
    ...
    static final class DatePatternImpl extends DateImpl {
    ...
    static class EnumImpl extends JSONTypeSerializer {
        ...
        static class EnumFieldNameData {
            ...
            public EnumFieldNameData(String enumNameTokenStr, char[] enumNameTokenChars, long[] enumNameTokenCharLongs,
                                     long[] enumNameTokenByteLongs, int tokenLength) {
        ...
        static class EnumInstanceImpl extends EnumImpl {
            ...
            EnumInstanceImpl(char[][] enumNameTokenChars) {
                ...
                for (int i = 0; i < enumNameTokenChars.length; ++i) {
                    ...
                    if (useUnsafe) {
                        enumFieldNameDatas[i] =
                                new EnumFieldNameData(null, null, JSONMemoryHandle.getCharLongs(enumNameTokenStr),
                                        JSONMemoryHandle.getByteLongs(enumNameTokenStr), chars.length);
                    } else {
                        if (EnvUtils.JDK_9_PLUS) {
                            enumFieldNameDatas[i] =
                                    new EnumFieldNameData(enumNameTokenStr, null, null, null, chars.length);
                        } else {
            ...
            protected void serialize(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent)
                ...
                if (!jsonConfig.isWriteEnumAsOrdinal()) {
                    ...
                    if (fieldNameData.useLong) {
                        writer.writeMemory(fieldNameData.enumNameTokenCharLongs, fieldNameData.enumNameTokenByteLongs,
                                fieldNameData.tokenLength);
                    } else {
                        if (EnvUtils.JDK_9_PLUS) {
...
//        protected void serialize(Object value, JSONWriter writer, JSONConfig jsonConfig, int indent) throws
//        Exception {
//            writer.writeJSONToken('"');
//            writer.write(value.toString());
//            writer.writeJSONToken('"');
...
//    }
    ...
    static class ArrayImpl extends JSONTypeSerializer {
        ...
        protected void serializeComponent(JSONTypeSerializer valueSerializer, Object value, Class<?> componentType,
                                          JSONWriter writer, JSONConfig jsonConfig, int indentLevel) throws Exception {
    ...
    static final class ArrayStringImpl extends ArrayImpl {
        ...
        @Override
        protected void serialize(Object obj, JSONWriter writer, JSONConfig jsonConfig, int indentLevel)
                throws Exception {
    ...
    static final class ArrayPrimitiveLongImpl extends ArrayImpl {
        @Override
        protected void serialize(Object obj, JSONWriter writer, JSONConfig jsonConfig, int indentLevel)
                throws Exception {
            boolean formatOut = jsonConfig.isFormatOut();
    ...
    static final class ArrayPrimitiveIntImpl extends ArrayImpl {
        @Override
        protected void serialize(Object obj, JSONWriter writer, JSONConfig jsonConfig, int indentLevel)
                throws Exception {
            boolean formatOut = jsonConfig.isFormatOut();
    ...
    static class CollectionImpl extends JSONTypeSerializer {
        ...
        protected void writeCollection(Object obj, JSONWriter writer, JSONConfig jsonConfig, int indentLevel)
                throws Exception {
            boolean formatOut = jsonConfig.isFormatOut();
                    ...
                    if (value != null) {
                        ...
                        if (valueClass == firstElementClass) {
                            ...
                            if (firstElementClass == null) {
                                ...
                                store.getTypeSerializer(valueClass)
                                        .serialize(value, writer, jsonConfig, indentLevelPlus);
                            }
                        }
                    } else {
                        writer.writeNull();
        ...
        static final class CollectionFinalTypeImpl extends CollectionImpl {
                ...
                for (Map.Entry<Object, Object> entry : entrySet) {
                    ...
                    if (value != null) {
                        JSONTypeSerializer valueSerializer =
                                store.getMapValueSerializer(value.getClass()); // getValueSerializer(value);
    ...
    static class ObjectImpl extends JSONTypeSerializer {
        ...
        protected void serialize(Object obj, JSONWriter writer, JSONConfig jsonConfig, int indentLevel)
            ...
            boolean isEmptyFlag =
                    !checkWriteClassName(writeClassName, writer, clazz, formatOut, indentLevel, jsonConfig);
        ...
        static final class ObjectWithTypeImpl extends ObjectImpl {
            ...
            protected boolean checkWriteClassName(boolean writeClassName, JSONWriter writer, Class clazz,
                                                  boolean formatOut, int indentLevel, JSONConfig jsonConfig)
                    throws IOException {
                writeType(writer, clazz, formatOut, indentLevel, jsonConfig);
                return true;
            }
        ...
        static final class ObjectWrapperImpl extends ObjectImpl {
    ...
    /**
     * 按指定日期格式化器写出日期时间；输出目标为字符数组写出器时直接写入内部缓冲区以提升性能。
     *
     * @param year          年
     * @param month         月
     * @param day           日
     ...
     * @throws Exception 写出过程中发生的异常
     */
    protected static final void writeDate(int year, int month, int day, int hourOfDay, int minute, int second,
                                          int millisecond, DateFormatter dateFormatter, JSONWriter writer)
            throws Exception {
        if (writer instanceof JSONCharArrayWriter) {
            JSONCharArrayWriter charArrayWriter = (JSONCharArrayWriter) writer;
            char[] buf =
                    charArrayWriter.ensureCapacity(dateFormatter.getEstimateSize() + JSONWriter.SECURITY_UNCHECK_SPACE);
    ...
    /**
     * 拆解通用日期对象的各时间字段后按指定格式化器写出。
     *
     * @param generalDate   通用日期对象
     * @param dateFormatter 日期格式化器
     * @param writer        json 输出目标
     * @throws Exception 写出过程中发生的异常
     */
    protected static final void writeGeneralDate(GeneralDate generalDate, DateFormatter dateFormatter,
    ...
    abstract static class ToIntegerImpl<E> extends JSONTypeSerializer {
