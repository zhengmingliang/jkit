...
/**
 * Created by 郑明亮 on 2018/9/10 23:12.
 */

/**
 * @author 郑明亮 @email 1072307340@qq.com
 * @version 1.0
 * @time 2018/9/10 23:12
 * TODO
 */
public class GifCaptcha extends Captcha {
    /**
     * 使用默认的宽高、字符个数与字体创建 GIF 验证码
     */
    public GifCaptcha() {
    }
    ...
    /**
     * 指定图片宽高、验证码字符个数与字体创建 GIF 验证码
     *
     * @param width 图片宽度，单位像素
     * @param height 图片高度，单位像素
     * @param len 验证码随机字符个数
     * @param font 绘制验证码字符使用的字体
     */
    ...
    private BufferedImage graphicsImage(Color[] fontcolor, char[] strs, int flag) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            g2d.drawLine(num(width), num(height), 5 + num(w), 5 + num(h));
