...
abstract class EvaluatorContextBuilder {
    ...
    static final class GeneralReusableImpl extends EvaluatorContextBuilder {
    ...
    static final class SibbingReusableImpl extends EvaluatorContextBuilder {
    ...
    static class SibbingTwinsReusableImpl extends EvaluatorContextBuilder {
        ...
        public EvaluatorContext createEvaluatorContext(Object context) {
            Object parentContext = parent.invokeDirect(context);
            return new EvaluatorContext.TwinsImpl(one, one.invokeCurrent(context, parentContext),
                    other.invokeCurrent(context, parentContext));
        }
    ...
    static final class SibbingTwinsRootReusableImpl extends SibbingTwinsReusableImpl {
    ...
    static final class SibbingRootReusableImpl extends EvaluatorContextBuilder {
    ...
    // a + b + c + ...
    static final class ReusablelessRootImpl extends EvaluatorContextBuilder {
        @Override
        public EvaluatorContext createEvaluatorContext(Object context) {
    ...
    // a + a
    static final class SingleReusableRootImpl extends EvaluatorContextBuilder {
    ...
    // a.b.c + 1 + 2 + 3
    static final class SingleReusableImpl extends EvaluatorContextBuilder {
