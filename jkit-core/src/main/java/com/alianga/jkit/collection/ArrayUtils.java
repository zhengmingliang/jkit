...
public class ArrayUtils {
     ...
     *
     * @param arr 数组
     * @return 数组不为 {@code null} 且长度大于 0 时返回 {@code true}，否则返回 {@code false}
     */
    ...
    /**
     * 深度比较两个元素是否相等，两者同为数组时按数组内容逐元素比较，否则退化为 {@code equals} 比较
     *
     * @param e1 第一个待比较的元素，不能为 {@code null}
     * @param e2 第二个待比较的元素
     * @return 两者内容相等时返回 {@code true}，否则返回 {@code false}
     */
     ...
     * @param array 数组
     * @param <T> 数组元素类型
     * @return 数组的首个元素，数组为 {@code null} 或为空时返回 {@code null}
     * @since 1.4.3
     */
     ...
     * @param <T> 数组元素类型
     * @return 数组的首个元素，数组为 {@code null} 或为空时返回 {@code defaultValue}
     * @since 1.4.3
     */
