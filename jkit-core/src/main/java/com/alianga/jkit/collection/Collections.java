...
public class Collections {
     ...
     * @param collection 集合
     * @param <T> 集合元素类型
     * @return 集合的首个元素，集合为 {@code null} 或为空时返回 {@code null}
     * @since 1.4.3
     */
     ...
     * @param <T> 集合元素类型
     * @return 集合的首个元素（{@link SortedSet} 取 {@code first()}，其余取迭代器返回的第一个元素），
     *         集合为 {@code null} 或为空时返回 {@code defaultValue}
     * @since 1.4.3
     */
     ...
     * @param collection 集合
     * @param <T> 集合元素类型
     * @return 集合的最后一个元素，集合为 {@code null} 或为空时返回 {@code null}
     * @since 1.4.5
     */
     ...
     * @param defaultValue 当{@code collection} 为空时，则返回该默认值
     * @param <T> 集合元素类型
     * @return 集合的最后一个元素，集合为 {@code null} 或为空时返回 {@code defaultValue}
     * @since 1.4.5
     */
    ...
    /**
     * Finds all the elements in the given collection which match the given predicate.
     * <p>
     * If the input collection or predicate is null, an empty list is returned.
     *
     * @param collection the collection to search, may be null
     * @param predicate the predicate to use, may be null
     * @param <T> the type of the collection elements
     * @return a new list holding every element of the collection which matches the predicate,
     * or an empty list if the collection or the predicate is null
     */
     ...
     * @param <O> the type of the transformed elements
     ...
     *
     * @param collection 集合
     * @return 集合中元素的个数，集合为 {@code null} 时返回 0
     * @since 1.4.5
     */
    ...
    public static boolean contains(Iterator<?> iterator, Object element) {
        if (iterator != null) {
            while (iterator.hasNext()) {
                ...
                if (com.alianga.jkit.Objects.deepEquals(candidate, element)) {
                    return true;
                }
            }
        }
