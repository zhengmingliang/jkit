/**
 * Created by 郑明亮 on 2022/3/6 14:58.
 */
package com.alianga.jkit;

import com.alianga.jkit.encode.AsciiEncoding;
...
public class Systems {
    private static final Log log = Log.get(Systems.class);
     ...
     * 新的一行(换行符)
     *
     * @return 当前系统的行分隔符，取自 {@code System.getProperty("line.separator")}
     */
    ...
    /**
     * Load system properties from a given filename or url with default REPLACE
     * <p>
    ...
    /**
     * Load system properties from a given set of filenames or URLs with default to {@link #REPLACE}.
     *
