...
import com.alianga.jkit.exception.VerifyException;
 ...
 *
 * <p>As with {@link Preconditions}, {@code Verify} uses {@link com.alianga.jkit.StringUtils#lenientFormat} to format
...
public final class Verify {
     ...
     * @param p1 the value substituted for the first {@code %s} placeholder in the message template
     ...
     * message is formed by replacing each {@code %s} placeholder in the template with an argument.
     * @param p1 the value substituted for the first {@code %s} placeholder in the message template
     * @param p2 the value substituted for the second {@code %s} placeholder in the message template
     * @since 23.1 (varargs overload since 17.0)
     */
    public static void verify(
     ...
     * @param p1 the value substituted for the first {@code %s} placeholder in the message template
     * @param p2 the value substituted for the second {@code %s} placeholder in the message template
     * @param p3 the value substituted for the third {@code %s} placeholder in the message template
     * @since 23.1 (varargs overload since 17.0)
     */
    public static void verify(
            boolean expression,
     ...
     * @param p2 the value substituted for the second {@code %s} placeholder in the message template
     * @param p3 the value substituted for the third {@code %s} placeholder in the message template
     * @param p4 the value substituted for the fourth {@code %s} placeholder in the message template
     * @since 23.1 (varargs overload since 17.0)
     */
    public static void verify(
            boolean expression,
     ...
     * @param reference the reference to check for nullness
