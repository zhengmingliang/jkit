package com.alianga.jkit.valid;

import com.alianga.jkit.StringUtils;

import java.util.function.Supplier;

import static com.alianga.jkit.StringUtils.lenientFormat;
 ...
 *
 * <p>{@code Preconditions} uses {@link StringUtils#lenientFormat} to format error message template
...
public final class Preconditions {
     ...
     * @param p1 the first argument to be substituted into the message template
     ...
     * @param errorMessageTemplate a template for the exception message should the check fail
     * @param p1 the first argument to be substituted into the message template
     * @param p2 the second argument to be substituted into the message template
     * @throws IllegalArgumentException if {@code b} is false
     * @since 1.4.1
     */
     ...
     * @param p1 the first argument to be substituted into the message template
     * @param p2 the second argument to be substituted into the message template
     * @param p3 the third argument to be substituted into the message template
     * @throws IllegalArgumentException if {@code b} is false
     * @since 1.4.1
     */
    public static void checkArgument(boolean b,
     ...
     * @param p2 the second argument to be substituted into the message template
     * @param p3 the third argument to be substituted into the message template
     * @param p4 the fourth argument to be substituted into the message template
     * @throws IllegalArgumentException if {@code b} is false
     * @since 1.4.1
     */
    public static void checkArgument(boolean b,
     ...
     * @param errorMessageTemplate a template for the exception message should the check fail
     * @param p1 the first argument to be substituted into the message template
     * @throws IllegalStateException if {@code b} is false
     * @since 1.4.1
     */
     ...
     * @see Verify#verifyNotNull Verify.verifyNotNull()
     */
    public static <T extends Object> T checkNotNull(T reference, RuntimeException exception) {
        if (reference == null) {
            throw exception;
        }
        return reference;
     ...
     * @see Verify#verifyNotNull Verify.verifyNotNull()
     */
    public static <T extends Object> T checkNotNull(T reference, Supplier<RuntimeException> supplier) {
        if (reference == null) {
            if (supplier != null) {
                throw supplier.get();
            } else {
