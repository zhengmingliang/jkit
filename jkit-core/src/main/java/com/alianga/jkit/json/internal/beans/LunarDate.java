...
public class LunarDate extends GregorianDate {
    ...
    private static final String[] TWELVE_CONSTELLATIONS =
            {"水瓶座", "双鱼座", "白羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座",
                    "射手座", "摩羯座"};

    /**
     * 天文台农历数据(1900~2049)，每个元素以 20 位十六进制编码当年的闰月位置、大小月分布
     */
    public static final long[] LUNAR_DATA =
            new long[]{0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0,
                    0x09ad0, 0x055d2, 0x04ae0, 0x0a5b6, 0x0a4d0, 0x0d250, 0x1d255, 0x0b540, 0x0d6a0, 0x0ada2, 0x095b0,
                    0x14977,
                    0x04970, 0x0a4b0, 0x0b4b5, 0x06a50, 0x06d40, 0x1ab54, 0x02b60, 0x09570, 0x052f2, 0x04970, 0x06566,
                    0x0d4a0,
                    ...
                    0x14573,
                    0x052d0, 0x0a9a8, 0x0e950, 0x06aa0, 0x0aea6, 0x0ab50, 0x04b60, 0x0aae4, 0x0a570, 0x05260, 0x0f263,
                    0x0d950,
                    0x05b57, 0x056a0, 0x096d0, 0x04dd5, 0x04ad0, 0x0a4d0, 0x0d4d4, 0x0d250, 0x0d558, 0x0b540, 0x0b5a0,
                    0x195a6,
                    0x095b0, 0x049b0, 0x0a974, 0x0a4b0, 0x0b27a, 0x06a50, 0x06d40, 0x0af46, 0x0ab60, 0x09570, 0x04af5,
                    0x04970,
                    0x064b0, 0x074a3, 0x0ea50, 0x06b58, 0x055c0, 0x0ab60, 0x096d5, 0x092e0, 0x0c960, 0x0d954, 0x0d4a0,
                    0x0da50,
                    0x07552, 0x056a0, 0x0abb7, 0x025d0, 0x092d0, 0x0cab5, 0x0a950, 0x0b4a0, 0x0baa4, 0x0ad50, 0x055d9,
                    0x04ba0,
                    0x0a5b0, 0x15176, 0x052b0, 0x0a930, 0x07954, 0x06aa0, 0x0ad50, 0x05b52, 0x04b60, 0x0a6e6, 0x0a4e0,
                    0x0d260,
    ...
    /**
     * 农历数据的起始时间戳，对应公历 1900-01-31（农历 1900 年正月初一）
     */
    public static final long LUNAR_DATA_TIME_BEGIN;
    /**
     * 农历数据的结束时间戳，对应公历 2050-01-23（农历 2050 年正月初一，不含）
     */
    ...
    /**
     * 根据公历日期构建农历日期，并立即换算农历、干支、生肖与星座信息
     *
     * @param date 公历日期
     */
    ...
    public LunarDate(int year, int month, int day, int hour, int minute, int second, TimeZone timeZone) {
        super(year, month, day, hour, minute, second, 0, timeZone);
    }

    /**
     * 根据公历年月日时分秒构建农历日期，使用默认时区
     *
     * @param year 公历年
     * @param month 公历月，取值 1-12
     * @param day 公历日
     ...
     *
     * @param lunarYear 农历年
     * @param lunarMonth 农历月，取值 1-12（含闰月位置）
     * @param lunarDay 农历日，取值 1-30
     */
     ...
     * 是否闰年
     *
     * @return 当前农历月份为闰月时返回 {@code true}，否则返回 {@code false}
     */
     ...
     * 获取生肖
     *
     * @return 与年天干对应的十二生肖名称，未换算过农历信息时可能为 {@code null}
     */
     ...
     * 获取星座
     *
     * @return 公历日期对应的十二星座名称，未换算过农历信息时可能为 {@code null}
     */
     ...
     * 获取十二节气交接日所在的月份
     *
     * @return 当日为十二节气交接日时返回该节气所在的月份（1-12），否则返回 0
     */
