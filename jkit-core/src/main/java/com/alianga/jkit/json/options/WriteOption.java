package com.alianga.jkit.json.options;
...
public enum WriteOption {
     ...
     * 快捷设置最大一级缩进
     *
     * @see com.alianga.jkit.json.JSONConfig#setMaxIndentLevel(int)
     */
     ...
     * <p> Format date
     * In consideration of the ease of use of dates, 'yyyy MM DD HH: mm: Ss' will be used regardless of whether the
     * date format is enabled or not
